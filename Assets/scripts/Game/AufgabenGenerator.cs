...
public class AufgabenGenerator{
    ...
    public Aufgabe getRandomAufgabe(){
        ...
        switch(aufgabenTyp){
            ...
            case 3:
                SaveSpielstand();
                return new Aufgabe("Spiel","Eine Runde Pferderennen",2);
            default:
    ...
    public void SaveSpielstand(){
        StaticGameParam.camPos = Camera.main.transform.position;
        //PlayerPos aus Static von ThrowDice
        StaticGameParam.Player1Pos = ThrowDice.Player1Pos;
        StaticGameParam.Player2Pos = ThrowDice.Player2Pos;
        StaticGameParam.Player3Pos = ThrowDice.Player3Pos;
        StaticGameParam.Player4Pos = ThrowDice.Player4Pos;
        StaticGameParam.MiniGameisLoadedFromGame = true;
    }
...
public class Aufgabe{
    ...
    public Aufgabe(string titel, string mesg, int mde){
        Titel = titel;
        message = mesg;
        mode = mde;
    }
